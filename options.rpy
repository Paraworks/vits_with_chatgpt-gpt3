...
define config.name = _("live2d_chat")
...
define gui.about = _p("""Create by Mahiruoshi""")


## 在构建的发布版中，可执行文件和目录所使用的短名称。此处仅限使用 ASCII 字符，并
## 且不能包含空格、冒号或分号。

define build.name = "live2d_chat"
...
define config.save_directory = "nijigaku_chat-1671252898"
