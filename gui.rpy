...
define gui.accent_color = '#1a1718'

## 当文本按钮既未被选中也未被悬停时使用的颜色。
define gui.idle_color = '#282426'

## 小的颜色用于小的文本，需要更亮/更暗才能达到同样的效果。
define gui.idle_small_color = '#1a1818'

## 当按钮和滑条被悬停时使用的颜色。
define gui.hover_color = '#181718'

## 当文本按钮被选中但非焦点时使用的颜色。当一个按钮为当前屏幕或设置选项值时，会
## 处于选中状态。
define gui.selected_color = '#1b1919'

## 当文本按钮无法被选择时使用的颜色。
define gui.insensitive_color = '#1210107f'

## 滑条未填充的部分使用的颜色。这些颜色不直接使用，但在重新生成条形图像文件时使
## 用。
define gui.muted_color = '#222020'
define gui.hover_muted_color = '#999999'

## 对话和菜单选择文本使用的颜色。
define gui.text_color = '#0e0e0e'
define gui.interface_text_color = '#1b1919'
